export const mockProperties = [
  { id: "p1", address: "14 Harbour View Tce", suburb: "Mosman", type: "House", status: "leased", weeklyRent: 1850, bedrooms: 4, bathrooms: 2, tenantName: "Sarah & James Whitfield", landlordName: "Michael Chen", leaseExpiry: "2025-08-15", maintenanceOpen: 1, imageUrl: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=800&q=80", landlordNotes: "Long-standing client since 2018. Prefers email comms. Keen on rent review in August — target 5% increase. HVAC serviced Jan 2025." },
  { id: "p2", address: "3/22 Pacific Highway", suburb: "Neutral Bay", type: "Apartment", status: "leased", weeklyRent: 720, bedrooms: 2, bathrooms: 1, tenantName: "Priya Sharma", landlordName: "Linda Park", leaseExpiry: "2025-03-31", maintenanceOpen: 2, imageUrl: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&q=80", landlordNotes: "Landlord is overseas (Singapore). Tenant lease has expired — renewal discussion urgent. Two open maintenance tickets causing frustration." },
  { id: "p3", address: "88 Milson Road", suburb: "Cremorne", type: "Townhouse", status: "vacant", weeklyRent: 1200, bedrooms: 3, bathrooms: 2, tenantName: "", landlordName: "David Okafor", leaseExpiry: "", maintenanceOpen: 0, imageUrl: "https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?w=800&q=80", landlordNotes: "Property refreshed with new carpet and paint (March 2025). Landlord expects re-let within 3 weeks. Professional photos booked for next Monday." },
  { id: "p4", address: "51 Holt Avenue", suburb: "Mosman", type: "House", status: "for-lease", weeklyRent: 2200, bedrooms: 5, bathrooms: 3, tenantName: "", landlordName: "Helena & Tom Russo", leaseExpiry: "", maintenanceOpen: 0, imageUrl: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&q=80", landlordNotes: "URGENT: Landlords considering removing from rental and selling. Keep them engaged — BDM call scheduled this week. Strong family home, good street." },
  { id: "p5", address: "7/190 Military Road", suburb: "Cremorne", type: "Apartment", status: "leased", weeklyRent: 580, bedrooms: 1, bathrooms: 1, tenantName: "Oliver Nguyen", landlordName: "Fiona Walsh", leaseExpiry: "2025-11-30", maintenanceOpen: 0, imageUrl: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&q=80", landlordNotes: "Excellent landlord, very responsive. Tenant Oliver is a model tenant — 3 years no issues. Fiona would like to discuss adding this unit to a portfolio package." },
  { id: "p6", address: "42 Raglan Street", suburb: "Mosman", type: "House", status: "for-sale", weeklyRent: 0, bedrooms: 4, bathrooms: 3, tenantName: "", landlordName: "Patricia Stanton", leaseExpiry: "", maintenanceOpen: 0, imageUrl: "https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=800&q=80", landlordNotes: "Currently listed for sale at $4.2M. TAG managing the sales campaign. If sale falls through, landlord open to returning to rental roll. Keep relationship warm." },
  { id: "p7", address: "12/5 Rangers Road", suburb: "Cremorne Point", type: "Apartment", status: "leased", weeklyRent: 950, bedrooms: 2, bathrooms: 2, tenantName: "Aaron & Kelly Thompson", landlordName: "James Li", leaseExpiry: "2025-06-14", maintenanceOpen: 3, imageUrl: "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&q=80", landlordNotes: "High-risk landlord (score 82). Three maintenance tickets unresolved >14 days — escalate to tradesperson today. Rent is 8% below median; propose review at lease renewal." },
  { id: "p8", address: "99 Spofforth Street", suburb: "Mosman", type: "House", status: "leased", weeklyRent: 2650, bedrooms: 5, bathrooms: 3, tenantName: "Claudia Barros", landlordName: "Raj Mehta", leaseExpiry: "2026-01-20", maintenanceOpen: 0, imageUrl: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80", landlordNotes: "Premium property, zero issues. Raj is our highest-NPS landlord — 10/10 last survey. Refer to BDM for potential referrals in his network." },
  { id: "p9", address: "3 Avenue Road", suburb: "Mosman", type: "House", status: "for-sale", weeklyRent: 0, bedrooms: 6, bathrooms: 4, tenantName: "", landlordName: "Genevieve Ford", leaseExpiry: "", maintenanceOpen: 0, imageUrl: "https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=800&q=80", landlordNotes: "Landmark Mosman residence. Listed at $6.8M. Genevieve is selective with agents — maintain white-glove service. Selling to downsize; potential funds to buy 2 investment properties." },
  { id: "p10", address: "18/40 Kurraba Road", suburb: "Neutral Bay", type: "Apartment", status: "leased", weeklyRent: 650, bedrooms: 2, bathrooms: 1, tenantName: "Ethan Clarke", landlordName: "Sue & Peter Yang", leaseExpiry: "2025-09-01", maintenanceOpen: 1, imageUrl: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800&q=80", landlordNotes: "One open maintenance ticket (dripping tap) — assigned to plumber, ETA Thursday. Lease renewal due Sep 1; Yangs OK with same rent for 12-month term." },
  { id: "p11", address: "25 Cabramatta Road", suburb: "Mosman", type: "Townhouse", status: "vacant", weeklyRent: 1400, bedrooms: 3, bathrooms: 2, tenantName: "", landlordName: "Anna Kowalski", leaseExpiry: "", maintenanceOpen: 0, imageUrl: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&q=80", landlordNotes: "Recently vacated (April 30). Bond claim processing. Anna wants property re-leased ASAP — she has a mortgage to cover. Enquiries already strong from portal listing." },
  { id: "p12", address: "8/33 Ben Boyd Road", suburb: "Neutral Bay", type: "Apartment", status: "leased", weeklyRent: 490, bedrooms: 1, bathrooms: 1, tenantName: "Marcus Johansson", landlordName: "Derek Holt", leaseExpiry: "2025-07-31", maintenanceOpen: 0, imageUrl: "https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=800&q=80", landlordNotes: "Entry-level investment property. Derek is considering selling — lease expiry in July is the trigger point. Discuss capital gains position and market timing at next contact." },
];
